...
export const areasData = {
  ...
  mercantil: {
    ...
    description:
      'Asesoramiento integral en derecho mercantil y societario para empresas y emprendedores.',
    longDescription:
  ...
  administrativo: {
    ...
    description:
      'Defensa especializada en procedimientos administrativos, recursos y reclamaciones ante la Administración.',
    longDescription:

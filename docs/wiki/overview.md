...
## Child Sections
- **[Getting Started](#1.1)**: Prerequisites, installation, and local development workflow.
- **[Project Structure](#1.2)**: Detailed explanation of the directory layout and Next.js conventions.
